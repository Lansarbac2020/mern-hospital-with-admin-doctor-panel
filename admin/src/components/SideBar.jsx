...
>
  <img src={assets.home_icon} alt='' />Dashboard
                ...
                to={'/all-appointments'}><img src={assets.appointment_icon} alt=''/>Appointment</NavLink>
                <NavLink
                className={({ isActive }) =>
                    `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${
                      isActive ? 'bg-[#F2F3FF] border-r-4 border-primary' : ''
                ...
                to={'/add-doctor'}><img src={assets.add_icon} alt=''/>Add Doctor</NavLink>
                <NavLink 
                ...
                to={'/doctor-list'}><img src={assets.people_icon} alt=''/>Doctors List</NavLink>
